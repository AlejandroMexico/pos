...
class modPos extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$this->rights[$r][1] = 'Terminal Manager';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 1;
		$this->rights[$r][4] = 'terms';

		$r++;
		$this->rights[$r][0] = 4000058;
		$this->rights[$r][1] = 'Add Products';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 1;
		$this->rights[$r][4] = 'add_product';

		$r++;
		$this->rights[$r][0] = 4000059;
		$this->rights[$r][1] = 'Show Stocks';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'show_stock';

		$r++;
		$this->rights[$r][0] = 4000060;
		$this->rights[$r][1] = 'Return Money';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'return_money';

		$r++;
		$this->rights[$r][0] = 4000061;
		$this->rights[$r][1] = 'Show all warehouses on Product Search';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'show_warehouses';
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=18',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'ControlCash',
									'mainmenu'=>'pos',
									'url'=>'/pos/backend/terminal/controlbank.php',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>101,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
