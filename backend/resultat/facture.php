...
if (!$user->rights->pos->backend)
{
	...
	$sql.= ' t.name as cash_name, pf.fk_cash';
	...
	if ($resql)
	{
		...
		print_liste_field_titre($langs->trans('User'),$_SERVER['PHP_SELF'],'u.firstname','',$param,'align="center"',$sortfield,$sortorder);
