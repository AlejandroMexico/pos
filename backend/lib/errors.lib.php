    ...
    switch ($value) {
        ...
        case -1:
            switch ($function) {
                ...
                case "doTranfer":
                    $ret['error']['value'] = 1;
                    $ret['error']['desc'] = $langs->trans("ErrTranferAmmountExceedAvailable");
                    $ret['data'] = $value;
                    break;
                default:
                    $ret['error']['value'] = 1;
        ...
        case -2:
            switch ($function) {
                ...
                case "doTranfer":
                    $ret['error']['value'] = 1;
                    $ret['error']['desc'] = $langs->trans("ErrCashWithoutControlAccount");
                    $ret['data'] = $value;
                    break;
                default:
                    $ret['error']['value'] = 1;
        ...
        case -3:
            switch ($function) {
                case "SetTicket":
                    $ret['error']['value'] = 1;
                    $ret['error']['desc'] = $langs->trans("ErrSavePayTicket");
                    $ret['data'] = null;
                    break;
                case "GetTicket":
                    $ret['error']['value'] = 1;
                ...
                case "doTranfer":
                    $ret['error']['value'] = 1;
                    $ret['error']['desc'] = $langs->trans("ErrTranferToSameAccount");
                    $ret['data'] = $value;
                    break;            
                default:
                    $ret['error']['value'] = 1;
        ...
        case -4:
            switch ($function) {
                ...
                case "doTranfer":
                    $ret['error']['value'] = 1;
                    $ret['error']['desc'] = $langs->trans("ErrorAccountCurrencyDiffer");
                    $ret['data'] = $value;
                    break;            
                default:
                    $ret['error']['value'] = 1;
