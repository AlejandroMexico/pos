...
class Ticket extends CommonObject
{
    ...
    public function fetch_lines()
    {
        ...
        $sql.= ' l.localtax1_tx, l.localtax1_type, l.localtax2_tx, l.localtax2_type,l.remise, l.remise_percent, l.fk_remise_except, l.subprice,';
        $sql.= ' l.rang,';
    ...
    public function addline2($line){
        $exclude = array("id");
        dol_syslog("Ticket::Addline2 ", LOG_DEBUG);
...
class TicketLigne extends CommonObject
{
    ...
    public $localtax1_type;        // Local tax 1
    public $localtax2_type;        // Local tax 2
    ...
    public function fetch($rowid)
    {
        ...
        $sql .= ' fd.localtax1_tx, fd.localtax2_tx, fd.localtax1_type, fd.localtax2_type, fd.remise, fd.remise_percent, fd.fk_remise_except, fd.subprice,';
    ...
    public function insert($notrigger = 0)
    {
        ...
        $sql .= ' (fk_ticket, fk_parent_line, description, qty, tva_tx, localtax1_tx, localtax2_tx, localtax1_type, localtax2_type,';
